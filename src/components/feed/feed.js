...
export default class feed extends Component {
  ...
  getFeed() {
    if (localStorage.getItem("token") !== undefined) {
      Axios.get("https://workout-tracker-be.herokuapp.com/api/feed") //eventually change this to followers driven feed
        .then((res) => {
      ...
      Axios.get("https://workout-tracker-be.herokuapp.com/api/feed")
        .then((res) => {
          this.setState({ ...this.state, feed: res.data.message });
        })
        .catch((err) => {
